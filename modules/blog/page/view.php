...
<div class="pageViewer">
	<a class="button<? echo ($page > 1) ? '" href="/blog/page-1" ' : ' disabled" '; ?>>&#171;</a>
	<a class="button<? echo ($page > 1) ? '" href="/blog/page-'.($page-1).'" ' : ' disabled" '; ?>>&#60;</a>
	<?php
	...
	?>
	<a class="button<? echo ($page < $pageCount) ? '" href="/blog/page-'.($page+1).'" ' : ' disabled" '; ?>>&#62;</a>
	<a class="button<? echo ($page < $pageCount) ? '" href="/blog/page-'.$pageCount.'" ' : ' disabled" '; ?>>&#187;</a>
</div>
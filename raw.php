<?php
	...
	echo '<ajax:title>'.$pageTitle.'</ajax:title>';
	echo '<ajax:canonical>'.$pageCanonicalLink.'</ajax:canonical>';
	echo '<ajax:description>'.$pageDescription.'</ajax:description>';
	echo '<ajax:keywords>'.implode(', ', $pageKeywords).'</ajax:keywords>';
	$tmp = array();
	...
	echo '<ajax:path>'.implode(';', $tmp).'</ajax:path>';
	 ...
	 // Include View
	 include_once($modulePath.'view.php');
?>